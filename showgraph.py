...
fig.suptitle('Graph of stock car in september 2010 - 2015(Thailand)',\
...
#graph2
    ...
    graphtwo(year_two, increase_car)

    plt.show()

def graphone(year_one, number_car):
...
def graphtwo(year_two, increase_car):
